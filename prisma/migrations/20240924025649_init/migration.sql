...
-- AddForeignKey
ALTER TABLE "marketing_sale" ADD CONSTRAINT "marketing_sale_discountid_fkey" FOREIGN KEY ("discountid") REFERENCES "discount"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
